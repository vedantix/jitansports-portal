...
const HERO_IMG = 'https://images.unsplash.com/photo-1549060279-7e168fcee0c2?w=1200&q=75';
    ...
    <div>
      ...
      <section className="relative h-[50vh] min-h-[380px] flex items-center overflow-hidden">
        <div className="absolute inset-0">
          <img src={HERO_IMG} alt="Personal Trainer Oss" className="w-full h-full object-cover" loading="eager" fetchPriority="high" decoding="async" />
