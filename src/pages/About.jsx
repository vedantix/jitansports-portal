    ...
    <div>
      ...
      <section className="relative h-[50vh] min-h-[400px] flex items-center overflow-hidden">
        <div className="absolute inset-0">
          <img src={content.about_hero_image} alt="Over JitanSports" className="w-full h-full object-cover" />
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="rounded-2xl overflow-hidden h-80 lg:h-[500px]">
            <img src={content.about_profile_image} alt="Jitan" className="w-full h-full object-cover" />
          </div>
          <div>
