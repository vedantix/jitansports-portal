...
const BENEFITS = [
  ...
  'Beschikbaar aan huis in Den Bosch en omgeving',
];
...
const FAQS = [
  ...
  { question: 'Kan JitanSports sportmassage aan huis uitvoeren in Den Bosch?', answer: 'Ja. We komen met onze professionele massagetafel naar jou toe in Den Bosch en omgeving. Geen reiskosten voor het werkgebied.' },
...
export default function SportmassageDenBosch() {
  return (
    <div>
      <SEO
        {...ROUTE_SEO['/sportmassage-den-bosch']}
        title={ROUTE_SEO['/sportmassage-den-bosch'].title}
        description={ROUTE_SEO['/sportmassage-den-bosch'].description}
        path="/sportmassage-den-bosch"
        image={HERO_IMG}
        jsonLd={[
          buildLocalBusinessSchema(),
          buildServiceSchema({
            name: 'Sportmassage Den Bosch',
            serviceType: 'Sportmassage',
            description:
              'Professionele sportmassage aan huis in Den Bosch voor sneller herstel, minder spierpijn, blessurepreventie en betere prestaties.',
            path: '/sportmassage-den-bosch',
            image: HERO_IMG,
          }),
          buildFAQSchema(FAQS),
      ...
      <PageHero
        image={HERO_IMG}
        title="Sportmassage in Den Bosch"
        subtitle="Professionele sportmassage aan huis in Den Bosch en omgeving. Herstel sneller, presteer beter en train zonder blessures."
      ...
      <section className="py-6 px-4 bg-primary/10">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-secondary font-semibold">Sportmassage aan huis in Den Bosch en omgeving - geen reiskosten!</p>
      ...
      <section className="px-4 py-16 md:py-20 lg:py-24">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
          <div>
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">Sportmassage is de massage voor actieve mensen en sporters in Den Bosch en omgeving. Of je nu recreatief sport of veel traint: sportmassage helpt je beter te presteren en sneller te herstellen.</p>
            ...
            <p className="text-muted-foreground leading-relaxed mb-8">Sportmassage is beschikbaar aan huis in Den Bosch en omgeving. We brengen onze professionele massagetafel mee. Geen reiskosten binnen het werkgebied.</p>
      ...
      <SeoSummary>
        <p>
          Jitan Sports biedt sportmassage in Den Bosch voor sporters en actieve mensen die sneller willen herstellen, minder spierpijn willen ervaren en blessures willen voorkomen. De behandeling richt zich op belaste spiergroepen, doorbloeding en herstel na training.
        </p>
      </SeoSummary>
